...
#ifndef PACKAGE_MASTER_INTERFACES__MSG__DETAIL__NUM__TYPE_SUPPORT_H_
#define PACKAGE_MASTER_INTERFACES__MSG__DETAIL__NUM__TYPE_SUPPORT_H_
...
#endif  // PACKAGE_MASTER_INTERFACES__MSG__DETAIL__NUM__TYPE_SUPPORT_H_
