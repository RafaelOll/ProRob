...
#ifndef PACKAGE_MASTER_INTERFACES__SRV__DETAIL__SEND_POSITIONS__FUNCTIONS_H_
#define PACKAGE_MASTER_INTERFACES__SRV__DETAIL__SEND_POSITIONS__FUNCTIONS_H_
...
/// Initialize srv/SendPositions message.
/**
...
/// Finalize srv/SendPositions message.
/**
...
/// Create srv/SendPositions message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * package_master_interfaces__srv__SendPositions_Request__init().
...
/// Destroy srv/SendPositions message.
/**
 * It calls
 * package_master_interfaces__srv__SendPositions_Request__fini()
...
/// Check for srv/SendPositions message equality.
/**
...
/// Copy a srv/SendPositions message.
/**
...
/// Initialize array of srv/SendPositions messages.
/**
...
/// Finalize array of srv/SendPositions messages.
/**
 * It calls
 * package_master_interfaces__srv__SendPositions_Request__fini()
...
/// Create array of srv/SendPositions messages.
/**
 * It allocates the memory for the array and calls
 * package_master_interfaces__srv__SendPositions_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SendPositions messages.
/**
 * It calls
 * package_master_interfaces__srv__SendPositions_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SendPositions message array equality.
/**
...
/// Copy an array of srv/SendPositions messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * package_master_interfaces__srv__SendPositions_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_package_master_interfaces
...
/**
 * It calls
 * package_master_interfaces__srv__SendPositions_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_package_master_interfaces
...
/**
 * It allocates the memory for the array and calls
 * package_master_interfaces__srv__SendPositions_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_package_master_interfaces
...
/**
 * It calls
 * package_master_interfaces__srv__SendPositions_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // PACKAGE_MASTER_INTERFACES__SRV__DETAIL__SEND_POSITIONS__FUNCTIONS_H_
