...
static const _SequenceElments_type_support_symbol_names_t _SequenceElments_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, package_master_interfaces, msg, SequenceElments)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, package_master_interfaces, msg, SequenceElments)),
  }
};
...
{
  return &::package_master_interfaces::msg::rosidl_typesupport_cpp::SequenceElments_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, package_master_interfaces, msg, SequenceElments)() {
  return get_message_type_support_handle<package_master_interfaces::msg::SequenceElments>();
}
