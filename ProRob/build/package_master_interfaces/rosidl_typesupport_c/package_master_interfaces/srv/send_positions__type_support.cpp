...
static const _SendPositions_Request_type_support_symbol_names_t _SendPositions_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, package_master_interfaces, srv, SendPositions_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, package_master_interfaces, srv, SendPositions_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, package_master_interfaces, srv, SendPositions_Request)() {
  return &::package_master_interfaces::srv::rosidl_typesupport_c::SendPositions_Request_message_type_support_handle;
}
...
static const _SendPositions_Response_type_support_symbol_names_t _SendPositions_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, package_master_interfaces, srv, SendPositions_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, package_master_interfaces, srv, SendPositions_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, package_master_interfaces, srv, SendPositions_Response)() {
  return &::package_master_interfaces::srv::rosidl_typesupport_c::SendPositions_Response_message_type_support_handle;
}
...
static const _SendPositions_type_support_symbol_names_t _SendPositions_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, package_master_interfaces, srv, SendPositions)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, package_master_interfaces, srv, SendPositions)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, package_master_interfaces, srv, SendPositions)() {
  return &::package_master_interfaces::srv::rosidl_typesupport_c::SendPositions_service_type_support_handle;
}
