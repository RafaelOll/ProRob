...
#include "package_master_interfaces/srv/detail/add_three_ints__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const package_master_interfaces::srv::AddThreeInts_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  package_master_interfaces::srv::AddThreeInts_Request & ros_message)
{
  // Member: a
  cdr >> ros_message.a;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = package_master_interfaces::srv::AddThreeInts_Request;
    is_plain =
      (
      offsetof(DataType, c) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const package_master_interfaces::srv::AddThreeInts_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<package_master_interfaces::srv::AddThreeInts_Request *>(
    untyped_ros_message);
...
{
  return &package_master_interfaces::srv::typesupport_fastrtps_cpp::_AddThreeInts_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, package_master_interfaces, srv, AddThreeInts_Request)() {
  return &package_master_interfaces::srv::typesupport_fastrtps_cpp::_AddThreeInts_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_package_master_interfaces
cdr_serialize(
  const package_master_interfaces::srv::AddThreeInts_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: sum
  cdr << ros_message.sum;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  package_master_interfaces::srv::AddThreeInts_Response & ros_message)
{
  // Member: sum
  cdr >> ros_message.sum;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = package_master_interfaces::srv::AddThreeInts_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const package_master_interfaces::srv::AddThreeInts_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<package_master_interfaces::srv::AddThreeInts_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &package_master_interfaces::srv::typesupport_fastrtps_cpp::_AddThreeInts_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, package_master_interfaces, srv, AddThreeInts_Response)() {
  return &package_master_interfaces::srv::typesupport_fastrtps_cpp::_AddThreeInts_Response__handle;
}
...
{
  return &package_master_interfaces::srv::typesupport_fastrtps_cpp::_AddThreeInts__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, package_master_interfaces, srv, AddThreeInts)() {
  return &package_master_interfaces::srv::typesupport_fastrtps_cpp::_AddThreeInts__handle;
}
