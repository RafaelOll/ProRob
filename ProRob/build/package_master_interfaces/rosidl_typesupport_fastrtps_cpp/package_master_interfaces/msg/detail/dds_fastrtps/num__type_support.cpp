...
#include "package_master_interfaces/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = package_master_interfaces::msg::Num;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const package_master_interfaces::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<package_master_interfaces::msg::Num *>(
    untyped_ros_message);
...
{
  return &package_master_interfaces::msg::typesupport_fastrtps_cpp::_Num__handle;
}
