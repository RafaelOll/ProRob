...
class Metaclass_SendPositions_Request(type):
    """Metaclass of message 'SendPositions_Request'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__send_positions__request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__send_positions__request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__send_positions__request
            cls._TYPE_SUPPORT = module.type_support_msg__srv__send_positions__request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__send_positions__request
...
class SendPositions_Request(metaclass=Metaclass_SendPositions_Request):
    """Message class 'SendPositions_Request'."""
...
class Metaclass_SendPositions_Response(type):
    """Metaclass of message 'SendPositions_Response'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__send_positions__response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__send_positions__response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__send_positions__response
            cls._TYPE_SUPPORT = module.type_support_msg__srv__send_positions__response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__send_positions__response
...
class SendPositions_Response(metaclass=Metaclass_SendPositions_Response):
    """Message class 'SendPositions_Response'."""
...
class Metaclass_SendPositions(type):
    """Metaclass of service 'SendPositions'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'package_master_interfaces.srv.SendPositions')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._TYPE_SUPPORT = module.type_support_srv__srv__send_positions

            from package_master_interfaces.srv import _send_positions
            if _send_positions.Metaclass_SendPositions_Request._TYPE_SUPPORT is None:
                _send_positions.Metaclass_SendPositions_Request.__import_type_support__()
            if _send_positions.Metaclass_SendPositions_Response._TYPE_SUPPORT is None:
                _send_positions.Metaclass_SendPositions_Response.__import_type_support__()


class SendPositions(metaclass=Metaclass_SendPositions):
    from package_master_interfaces.srv._send_positions import SendPositions_Request as Request
    from package_master_interfaces.srv._send_positions import SendPositions_Response as Response
